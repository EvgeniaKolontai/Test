...
//         if ( Words[i].Length <= 3)
//         {
//             int lenght =ArrayA.Length;
//             Array.Resize(ref ArrayA, lenght +1);
//             Words[i] = ArrayA[j];
//             j++;
...
//     return(ArrayA); 
// }
// void WriteArray(string[] Words, string[] ArrayA)
